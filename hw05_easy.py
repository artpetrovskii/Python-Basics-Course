# Задача-1: Напишите скрипт, создающий директории dir_1 - dir_9
# в папке, из которой запущен данный скрипт.
...
# Задача-3: Напишите скрипт, создающий копию файла, из которого запущен данный скрипт.
